...
#             throw(ArgumentError(string('"', fname, "\" is not a JLD3 file")))
#         else
#             #@warn("This file was written with an older version of JLD3. Attempting to load data.", maxlog=1)
#             return
#         end
#     end
...
#         @warn("""This file was written in a newer version of the JLD3 file format.
#         Please consider updating JLD3.""", maxlog=1)
#     end
#     if ver ∉ COMPATIBLE_VERSIONS
#         @warn("""This file was written with a different version of JLD3 that may not be compatible.
